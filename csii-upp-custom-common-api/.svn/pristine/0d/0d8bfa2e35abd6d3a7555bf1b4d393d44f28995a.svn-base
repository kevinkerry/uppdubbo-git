...
public class EATLReq extends FundProcessReqHead {
	private static final long serialVersionUID = -4850759452470639182L;
    ...
    private String subDeductAmt; 
    private String subRealAmt; 
    ...
    public static class PayeeAcct implements Serializable{
		...
		private static final long serialVersionUID = 2404809755863184421L;
		private String subTransAmt;
    	private String subDeductAmt;
    	private String subRealAmt;
    	private String payeeAcctDeptNbr;
		...
		public String getSubDeductAmt() {
			return subDeductAmt;
		}
		public void setSubDeductAmt(String subDeductAmt) {
			this.subDeductAmt = subDeductAmt;
		}
		public String getSubRealAmt() {
			return subRealAmt;
		}
		public void setSubRealAmt(String subRealAmt) {
			this.subRealAmt = subRealAmt;
		}
