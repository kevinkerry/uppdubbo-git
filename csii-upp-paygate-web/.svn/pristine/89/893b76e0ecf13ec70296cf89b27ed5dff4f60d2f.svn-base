...
<body  onload="onload();">
   <div class="main">
      ...
      <div class="content">  
        <form id="form1" name="form1" method="post" action="FS03Input.do"  >  
           <pe:hidden fieldList="SignNbr,SignTypCd,ChannelNbr,PayTypCd,PayerAcctDeptNbr" skipNULL="true"/> 
         ...
         <input type="hidden" name="state" id="state" value="${state}"/>
          <input id="TransTypCd" name="TransTypCd" type="hidden" value="UPP10014"/>
           <div class="con_r">
             <div class="con_r_main">
                       <div class="dingw">您可以在此调整丰收e支付交易限额</div>
                        ...
                        <div class="btn_big">
                               <input type="button"  value="上一步" class="xia_btn" id="doitbtn" onclick="Cancel();"/>
