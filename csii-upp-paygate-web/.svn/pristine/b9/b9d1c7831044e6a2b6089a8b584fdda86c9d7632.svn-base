   ...
   <div class="main">
      ...
      <div class="content" style="height: 600px;">
       <form action="#" method="post">
		<pe:hidden fieldList="AcctType,PayerAcctNbr,CifNo,PayerPhoneNo,PlainContext,Plain,ChannelId,MerDate,MerchantName,TransAmt,DeptId,AcctName,Signature,SmsSqenbr" skipNULL="false"/>
           <div class="con_l">
		...
		<div id="example"> </div> 
           ...
           <div class="con_r">
                  ...
                  <div class="con_r_main">
                       <div class="dingw2 dingw">您的位置：网银支付 > 支付结果</div> 
                        <div class="sr_main3 sr_main2" >
                            ...
                            <div class="duig_r">
                                  ...
                                  <c:if test="${PayStatus == '3'}">订单处理中</c:if>
