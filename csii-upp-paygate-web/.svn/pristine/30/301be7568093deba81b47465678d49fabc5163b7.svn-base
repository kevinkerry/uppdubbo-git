...
<body>
	<form id="form_id" name="form1" action="#" method="post">
		...
		<pe:hidden
			fieldList="PayTypCd,PayerCardTypCd,PayerAcctDeptNbr,PayerAcctName,OrderId,PlainContext,Plain,ChannelNbr,MerchantName,TransAmt,Signature,TransId,PayTypeCdStr"
			skipNULL="false" />
		...
		<div class="logo">
			<div class="">
				丰收e支付注册 <a href="###" class="leftBt"><img
		...
		<div class="main">
			<table width="100%" border="0" cellpadding="1" cellspacing="0">
				...
				<tr id="tr_selectbankcard">
					<td class="right left">卡&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</td>
					<td class="srk"><select id="select_payBankCardNbr"></select></td>
				</tr>
				...
				<tr id="tr_tip" >
					<td class="right left" style="padding-right:18px;">
						 <input class="mgc" style="width: 16px;" id="sign" name="sign" type="checkbox"/>
						<label for="sign"></label> 
						<!-- <input type="checkbox" name="sign" id="sign" class="chk_2" /><label for="sign">我接受</label> -->
                    </td>
            <td class="font14"><a href="#" id="open-box">我已阅读并接受《浙江农信丰收e支付服务协议》</a></td>
				...
				<tr id="tr_smscode">
					...
					<td class="srk"><input id="SmsCode" name="SmsCode"
						autocomplete="off" placeholder="输入验证码" type="tel"
						style="width: 40%" maxlength="6" /> <input id="SMSbutton"
		...
		<div class="bottom_botton">
			...
			<input id="btn_back" class="peory khzf" value="返回选卡支付" type="button" />
			<input id="btn_OpenPay" class="peory khzf" value="注册并支付" type="button" />
		</div>
	</form>
