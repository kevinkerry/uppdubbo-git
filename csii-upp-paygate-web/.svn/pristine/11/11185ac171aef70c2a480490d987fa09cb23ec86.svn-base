      ...
      <div class="content">  
           ...
           <div class="con_r">         
             <div class="con_r_main">
                       ...
                       <form id="form1" name="form1" method="post" action="FS02Login.do"  onsubmit="return beforeSubmit();" >  
                        <div class="sr_main">
                       ...
                       <input type="hidden" name="state" id="state" value="${state}"/>
                              <table width="550" border="0" style="margin:20px auto;" >
                                ...
                                <tr>
                                  ...
                                  <td width="70%"><input autocomplete="off"   name="PayerPhoneNo" id="PayerPhoneNo"  onblur="checkPhone();"/><span id="PayerPhoneNoInfo" class="cheng"> *</span></td>
                        ...
                        <div class="wxts">
                              <div class="tub"></div>
                              <div class="wxts_main" style="height:10px;">                                                           
                              </div>
                        </div>
             </div>
           </div>
