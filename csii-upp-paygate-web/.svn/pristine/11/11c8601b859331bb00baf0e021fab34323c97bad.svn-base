...
<!--      <script language="javascript" type="text/javascript" src="script.do"></script> -->
    ...
    <script type="text/javascript">
        ...
        function goBack() {
            var resp = "${RespCode}";
            if ("PAY0122" == resp||resp =="PAY0035"||"PAY0121" == resp) {
        ...
        <c:choose>
            <c:when test="${RespCode=='0000000'}">
                ...
                <div class="bottom_botton">
                    <input onClick="ToSuccessMerchant();" value="返回" type="button"/>
                </div>
            ...
            <c:otherwise>
                ...
                <div class="bottom_botton" >
                    <input onClick="ToFailedMerchant();" value="返回" type="button" style="width: 100%"/>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
