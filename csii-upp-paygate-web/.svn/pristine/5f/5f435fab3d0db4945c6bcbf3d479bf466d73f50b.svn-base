           ...
           <div class="con_r">
             ...
             <div class="con_r_main">
                       <div class="dingw">您可以在此注销丰收e支付服务</div>
                        ...
                        <div id="height">&nbsp;</div>
                         <input name="AcctNo" id="AcctNo"  type="hidden" value="${PayerAcctNbr}"/>
                        <pe:hidden fieldList="AcctType,CifNo,DeptId" skipNULL="true"/>
                              <table width="550" border="0" style="margin:30px auto; a:hover{text-decoration:none;} " >
                                <tr>
                                	<td width="83"><img src="images/phone/dui.png"/></td>
                                  <td align="center">您尾号为<a id="acct" name="acct"></a>的卡丰收e支付功能注销成功！欢迎再次使用!</td>
                                </tr>                
