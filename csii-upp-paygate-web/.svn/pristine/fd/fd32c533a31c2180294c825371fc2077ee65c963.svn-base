...
<script src="js/style.js"></script>
    ...
    function doIt() {
     ...
     function getSMSFunction(){
         ...
         var oparams;
         if (document.forms[0].PayerAcctDeptNbr!=undefined){
...
<body  onload="onload();">
   <div class="main">
      ...
      <div class="content">  
        <form id="form1" name="form1" method="post" action="FS05ThawUpdateStatus.do"  >  
           <pe:hidden fieldList="SignNbr,SignTypCd,ChannelNbr,PayTypCd,PayerAcctDeptNbr,PayerCardPwd" skipNULL="true"/> 
           <input id="TransTypCd" name="TransTypCd" type="hidden" value="UPP10006"/>
