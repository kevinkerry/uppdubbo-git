...
<script>
	...
	function getSMSFunction() {
		...
		var oparams = new Array(new Pair("PayerAcctNbr", PayerAcctNbr),new Pair("PayerAcctDeptNbr", payerAcctDeptNbr),
				new Pair("PayerPhoneNo", PayerPhoneNo), new Pair("OperateType", "0"), new Pair(
						"TransTypCd", "UPP10019"));
		...
		<div class="main-nav">
			<ul class="main-nav-in">
				...
				<li><a
					...
					href="/paygate/FS07.do">注销</a></li>
			</ul>

		</div>
		<div class="content">
			<form id="form1" name="form1" method="post" action="FS07Input.do">
			<pe:hidden fieldList="AcctType,CifNo,DeptId,Password,PayerAcctDeptNbr" skipNULL="true" />
				...
				<div class="con_r_main">
					...
					<div class="sr_main"> 
						<table width="620" border="0" 
							...
							<div id="QQQ" style="margin-left: 210px;">
								<span id="SMSinfo" class="cheng" style="margin-left: 150px;"></span>
							</div>
						</form>
					</div>
					<div class="btn_big">
						<input type="button" value="取消"
							onclick="back()" class="xia_btn" />
						<input type="button" value="确认" id="doNext" class="xia_btn"
							onclick="doIt();" /> 
					...
					<div class="wxts">
						<div class="tub"></div>
						<div class="wxts_main"></div>
					</div>
				</div>
			</div>
			</form>
		</div>
		<div class="footer">Copyright © 2004-2015 浙江省农村信用社联合社版权所有
			400-8896596 浙ICP备12003222号</div>
	</div>
