...
<body  onload="onload()">
   <div class="main">
      ...
      <div class="content">
            <form id="form1" name="form1" method="post" action="FS02Input.do"  >
                <input type="hidden" name="state" id="state" value="${state}"/>
                    <pe:hidden fieldList="TransTypCd,PayerAcctNbr,PayerPhoneNo,CustCifNbr,PayerAcctDeptNbr,PayerCardTypCd" skipNULL="true"/> 
           <div class="con_r">   
             <div class="con_r_main">
                       <div class="dingw">您可以在此查询丰收e支付的交易明细</div>
                               ...
                               <table width=620" border="0" 
								...
								<tr style="height:50px" ;>
									...
									<td width="67%"><input autocomplete="off" id="SmsCode"
										...
										maxlength="6"  />  <input
										style="background-image: url(images/images/xiayi.png); width: 124px; height: 42px; border: none; color: #fff; font-size: 16px; font-weight: bold;"
										id="SMSbutton"  onclick="getSMS();" value="获取验证码"
										type="button" /> <span id="MessageCodeInfo" class="cheng">*</span>
						...
						<table>
                            <tr>
                                <td  class="right" style="width: 188px;height: 50px;">附&nbsp;&nbsp;加&nbsp;&nbsp;码&nbsp;&nbsp;：</td>
                   ...
                   <div id="QQQ" > <span  id="SMSinfo" class="cheng"  style="margin-left: 41%;" ></span>	
                        ...
                        <div class="btn_big">
                               <input type="reset"  value="取消" class="xia_btn" id="doitbtn" onclick="Cancel();"/>
