      ...
      <div class="content">           
           <div class="con_r">               
             <div class="con_r_main">
                       ...
                       <form id="form1" name="form1" method="post" action="FS05ThawConfirm.do"> 
                        <div class="sr_main">
                         <pe:hidden fieldList="PayerAcctNbr,CardValidM,CardValidY,PayerPhoneNo,PayerCardTypCd,PayerAcctDeptNbr,CustCifNbr,PayerIdNbr,PayerIdTypCd,PayerCardPwd" skipNULL="true"/>
                        <input name="AcctNo" id="textfield" value="${PayerAcctNbr}" type="hidden"/>
                        <input type="hidden" name="state" id="state" value="${state}"/>
                        <input name="PaperType" id="textfield" value="${PayerIdTypCd}" type="hidden"/>
                        <input name="PaperNo" id="textfield" value="${PayerIdNbr}" type="hidden"/> 
                              <table width="260" border="0" style="margin:20px auto;" >
                                <tr>
                                  <td width="109" class="right" style="letter-spacing: 0.1px;">卡&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</td>
                                  <td width="295">${PayerAcctNbr}</td>
                                </tr>
                           <tr>
                                  <td width="109" class="right">手机号码：</td>
                                  <td width="295">${PayerPhoneNo}</td>
                                </tr>
                                  <tr>
                              ...
                              <tr>
                                  ...
                                  <td width="295">${PayerIdNbr}</td>
                                </tr>
                              
                              </table>  	
              			 </div>
                        <div class="btn_big">
                             <input type="button"  value="取消"  onclick="Cancel();" class="xia_btn"/>
