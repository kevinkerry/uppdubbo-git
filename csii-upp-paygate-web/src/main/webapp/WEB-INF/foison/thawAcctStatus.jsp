...
function onload(){
	...
	var PayerAcctNbr= PayerAcctNbr.substr(PayerAcctNbr.length-4);
	$('#acct').text(PayerAcctNbr);
}
</script>
           ...
           <div class="con_r">
             ...
             <div class="con_r_main">
                      ...
                      <form id="form1" name="form1" method="post" action="#"> 
                       <div id="height">&nbsp;</div>
                              <table width="400px" border="0" style="margin:20px auto; a:hover{text-decoration:none;} " >
                                <tr>
                                 <td width="83"><img src="images/phone/dui.png"/></td>
                                  <td align="center">您尾号为<a id="acct" name="acct"></a>的卡丰收e支付解冻成功!</td>
                                </tr>
