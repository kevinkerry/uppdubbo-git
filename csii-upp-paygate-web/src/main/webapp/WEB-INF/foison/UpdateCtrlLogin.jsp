      ...
      <div class="content">
           <div class="con_r">
             <div class="con_r_main">
                      ...
                      <form id="form1" name="form1" method="post" action="FS03Login.do"  onsubmit="return beforeSubmit();" > 
                        <div class="sr_main">
                        ...
                        <input type="hidden" name="state" id="state" value="${state}"/>
                              <table width="550" border="0" style="margin:20px auto;" >
                                <tr>
                                  ...
                                  <td width="70%" ><input   value="" autocomplete="off" name="PayerAcctNbr" id="PayerAcctNbr"  onblur="checkPayerAcctNbr();" /><span id="PayerAcctNbrInfo" class="cheng"> *${RespMessage}</span> </td>
                                </tr>
                                <tr>
                                  <td class="right" width="25%">手机号码：</td>
                                  <td width="70%"><input  value="" autocomplete="off" name="PayerPhoneNo" id="PayerPhoneNo"  onblur="checkPhone();"/><span id="PayerPhoneNoInfo" class="cheng"> *${RespMessage2}</span></td>
                                </tr>
                                <tr>
