	...
	<script>
		...
		$(function(){
			...
			$('#gobackone').click(function() {
				document.forms[0].action="IPER.do";
				document.forms[0].MsgFlag.value="000001";
				document.forms[0].submit();
			});
   ...
   <div class="main">
      ...
      <div class="content">
       <form action="#" method="post">
		<pe:hidden fieldList="realAmt,AcctType,PayerAcctNbr,CustCifNbr,PlainContext,Plain,ChannelId,MerDate,MerchantName,TransAmt,DeptId,AcctName,Signature,RespCode,MsgFlag,MerURL1,PayTypeCdStr" skipNULL="false"/>
