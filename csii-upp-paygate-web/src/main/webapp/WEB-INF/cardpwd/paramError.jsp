...
<body>
   <div class="main">
      ...
      <div class="content" style="height: 600px;">
     	    ...
     	    <pe:hidden fieldList="PayTypCd,PayerCardTypCd,PayerAcctNbr,CustCifNo,PayerPhoneNo,OrderId,MobileNo,PlainContext,Plain,ChannelId,MerDate,MerchantName,TransAmt,PayerAcctDeptNbr,PayerAcctName,Signature" skipNULL="true"/>
           <div class="con_l">
