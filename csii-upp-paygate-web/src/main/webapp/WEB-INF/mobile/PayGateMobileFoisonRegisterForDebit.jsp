...
<body onload="LoadJs()">
	...
	<pe:hidden fieldList="PayerIdTypCd,PayerCardTypCd,AcctNo,PayerAcctDeptNbr,PayerPhoneNo,PayerAcctNbr,PayerAcctName,CustCifNbr,PlainContext,Plain,ChannelNbr,OrderId,MerDate,MerchantName,Signature,TransAmt,PayerIdNbr" skipNULL="true"/>
    ...
    <div class="main">
    	<table width="100%" border="0" cellpadding="1" cellspacing="0">
            ...
            <tr>
                ...
                <td class="srk">
                	<select name="PayerIdTypCd" id="PayerIdTypCd">
			...
			<tr>
             ...
             <tr>
                            ...
                            <td class="srk"><input autocomplete="off" size="10" maxlength="7" type="text" onblur="checkTellerNo()" placeholder="邀请人柜员号，可不填"  name="TellerNo" id="TellerNo" style="width: auto;height: 24px;"/>
                            </td>
            </tr>
            <tr>
