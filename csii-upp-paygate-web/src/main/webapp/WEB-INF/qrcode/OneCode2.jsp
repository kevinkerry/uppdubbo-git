...
<title>科蓝一码付</title>
	...
	<script>
	function doIt(clickObj,code,url,mername) {
		var transAmt = $('#transAmt').val();
    	 $.ajax({
				type: "POST",
				async: false,
				url: "/paygate2/createOrder",
				data: "TransName=QRCO&TransAmt="+transAmt+"&code="+code+"&MerchantName="+mername+"&url"+url,
	...
	<div class="order">
		<table width="100%" border="0" cellpadding="1" cellspacing="0" style="background-color: rgba(158, 202, 241, 0.12);">
            ...
            <tr>
                ...
                <td  style="padding-left: 0px;text-align: left;">￥<input type="text" id="transAmt" value="" pattern="#,###,##0.00"/></td>
            </tr>
    	</table>
	</div>
	<div class="bottom_botton">
        <input onclick="doIt(this,'${code}','${url}','${MerchantName}');" class="peory" value="确认支付" type="button"/>
