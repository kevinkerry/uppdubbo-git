...
public class CheckAction1 extends PayGateAction {

	@Override
	public void execute(Context context) throws PeException {
		// TODO Auto-generated method stub
		String url = "http://ww.7har.com/paygate2/qrCode?TransName=QRCM&MerchantName="+context.getString(Dict.MERCHANT_NAME)+"&TransAmt="+context.getString(Dict.TRANS_AMT);
		String str1 = null;
