 ...
 * 
 */
public class ReqAcctItlDep extends ReqEAccountHead {
	public ReqAcctItlDep(InputFundData data) {
		super(data);
		// 交易码
		this.setTransCode(EAccountTransCode.AcctItlDep);
		this.setItlnbr(Long.parseLong(data.getPayeeacctnbr()));//收款人账号
		this.setAcctnbr(data.getPayeracctnbr());
