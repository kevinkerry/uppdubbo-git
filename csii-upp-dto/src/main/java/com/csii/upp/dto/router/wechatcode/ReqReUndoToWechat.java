 ...
 * @version: 1.0
 * @Remark: 只有二维码被扫模式支付才能做撤消
 */
public class ReqReUndoToWechat extends ReqWeChatCodeHead {
	...
	public ReqReUndoToWechat(InputFundData data) {
		super(data);
		this.setTxnCode(QrCodePreTransCode.WeChatCodeActivePayUndo);
