 ...
 *
 */
public class ReqCoreDebitVirtualRefoundTrans extends ReqCoreHead {
	...
	public ReqCoreDebitVirtualRefoundTrans(InputFundData data) {
		super(data);
		this.setTransCode(CoreTransCode.CoreDebitVirtualRefound);
