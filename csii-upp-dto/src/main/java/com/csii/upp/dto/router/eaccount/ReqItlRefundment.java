...
public class ReqItlRefundment extends ReqEAccountHead {
	private BigDecimal tranAmt;		//金额
	private String currencyCd;		// 币种
	private String summary;			//摘要
	private String rtxnDesc;		//备注
	
	public ReqItlRefundment(InputFundData data) {
		super(data);
		setTransCode(EAccountTransCode.ItlRefundment);
		this.setTranAmt(data.getTransamt());
		this.setCurrencyCd(data.getCurrencycd());
		this.setSummary("应收手续费");
		this.setRtxnDesc("应收手续费");
	}
