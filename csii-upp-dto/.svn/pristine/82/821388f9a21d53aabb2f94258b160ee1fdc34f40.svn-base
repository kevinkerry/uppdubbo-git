...
public class BatchcleartransExample {
    /**
     * This field was generated by MyBatis Generator.
     * This field corresponds to the database table BATCHCLEARTRANS
     *
     * @mbggenerated
     */
     ...
     * @mbggenerated
     */
    protected BatchcleartransExample(BatchcleartransExample example) {
