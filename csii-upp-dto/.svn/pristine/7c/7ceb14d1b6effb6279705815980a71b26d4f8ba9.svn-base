 ...
 *
 */
public class ReqWeChatCodeActivePay extends ReqWeChatCodeHead {
	...
	public ReqWeChatCodeActivePay(InputFundData data) {
		super(data);
		this.setTxnCode(QrCodePreTransCode.WeChatCodeActivePay);
