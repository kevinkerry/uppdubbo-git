package com.csii.upp.batch.appl.ccore;
...
public class CheckCCoreAppl extends BaseCheckAppl {
	...
	@Override
	protected CheckUpdateStatus checkDownRtxnNotExist(PreClearCheckTrans preClearCheckTrans, Date intervalDate,
			String checkdataflag) {
		// TODO Auto-generated method stub
		return null;
	}
