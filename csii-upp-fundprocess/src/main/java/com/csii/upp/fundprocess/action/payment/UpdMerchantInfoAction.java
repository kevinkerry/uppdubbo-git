 ...
 *
 */
public class UpdMerchantInfoAction extends PayOnlineAction {
	...
	public void execute(Context context) throws PeException {
		...
		if("01".equals(context.getString(Dict.PROXY_SYN_TYPE))){
			 output = getAliPayService().updAlipayMerchantInfo(input);
			 ...
			 output2 = getWechatService().updWCMerchantInfo(input);
